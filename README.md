...
- **Analyze Korean office documents** - the optional [Kordoc RAG-ready parser](docs/kordoc-mcp.md) reads the structure, metadata, pages, and tables of one workspace-contained document without enabling document editing or generation.
