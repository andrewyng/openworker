...
The agent is told, each turn, which credentials it was given and what they let it do, and
it is told when its sandbox was recreated because a folder changed. It is not told
anything about the machine outside the sandbox.
