...
TOOL_DEFS: tuple[ConnectorToolDef, ...] = (
    ConnectorToolDef(
        ...
        "Read public URL",
        "read",
        "Fetch readable text from a public URL without opening the live browser.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_open_url",
        "Open URL",
        "write",
        "Open an HTTP(S) URL in the attended in-app browser.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_history",
        "Browser history",
        "write",
        "Go back, forward, or reload the active browser tab.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_snapshot",
    ...
    ConnectorToolDef(
        ...
        "Continue snapshot",
        "read",
        "Read the next chunk of a truncated accessibility snapshot.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_screenshot",
    ...
    ConnectorToolDef(
        ...
        "Click element",
        "write",
        "Click an element referenced by a fresh page snapshot.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_fill",
        "Fill field",
        "write",
        "Replace the contents of a referenced editable element.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_press",
        "Press key",
        "write",
        "Press a keyboard key on a referenced element.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_select",
        "Select option",
        "write",
        "Select an option value in a referenced select element.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_hover",
    ...
    ConnectorToolDef(
        ...
        "Scroll page",
        "write",
        "Scroll the viewport or a referenced scroll area.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_tabs",
        "List tabs",
        "read",
        "List the attended browser's open tabs.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_select_tab",
    ...
    ConnectorToolDef(
        ...
        "Resolve dialog",
        "write",
        "Accept or dismiss the active tab's JavaScript dialog.",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "read",
        "Choose the in-app browser or a connected shared-tab surface.",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "read",
        "Show or hide the in-app Browser without changing page state.",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "Set viewport",
        "read",
        "Override or reset the responsive viewport for visual testing.",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "Finalize tabs",
        "write",
        "Close intermediate tabs and retain the requested deliverable tabs.",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "Move agent pointer",
        "read",
        "Move the visible agent pointer without clicking.",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "Coordinate click",
        "write",
        "Click viewport coordinates after live target classification.",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "Coordinate drag",
        "write",
        "Drag through a bounded viewport path.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_type_text",
        "Type focused text",
        "write",
        "Type into the focused browser element.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_keypress",
        "Press focused keys",
        "write",
        "Press keys on the focused browser element.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_clipboard",
        "Session clipboard",
        "write",
        "Read, write, or paste the isolated browser-session clipboard.",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "Read console logs",
        "read",
        "Read recent console messages and page errors.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_download",
        "Download file",
        "write",
        "Save a browser download into an approved local file root.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_upload",
        "Upload file",
        "write",
        "Attach approved local files to a browser file input.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_cdp",
        "Run CDP command",
        "write",
        "Run an action-time-approved CDP command in Developer Mode.",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "Read DOM query",
        "read",
        "Run one fixed, read-only DOM query.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_surfaces",
        ...
        "read",
        "List exact browser surface availability without opening a browser.",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "read",
        "Load runtime-generated documentation for one browser surface.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_close",
        "Close browser",
        "write",
        "Stop this task's selected browser use without disconnecting shared tabs.",
    ),
    ConnectorToolDef(
        "github",
        "github_search",
