...
TOOL_DEFS: tuple[ConnectorToolDef, ...] = (
    ...
    ConnectorToolDef(
        ...
        "read",
        "List local desktop programs explicitly allowed in Settings.",
    ),
    ConnectorToolDef(
        "computer",
        ...
        "Find app windows",
        "read",
        "Find visible windows for an installed desktop application.",
    ),
    ConnectorToolDef(
        "computer",
        "computer_snapshot",
        "Read app window",
        "read",
        "Read a fresh accessibility snapshot.",
    ),
    ConnectorToolDef(
        "computer",
        "computer_screenshot",
        ...
        "write",
        "Save a screenshot of an allowed desktop window.",
    ),
    ConnectorToolDef(
        "computer",
        "computer_open_program",
        "Open allowed program",
        "write",
        "Open one local desktop program selected in Settings.",
    ),
    ConnectorToolDef(
        "computer",
        "computer_click",
        "Click desktop app",
        "write",
        "Click a labelled element in an allowed desktop program.",
    ),
    ConnectorToolDef(
        "computer",
        "computer_type_text",
        "Type in desktop app",
        "write",
        "Type text in an allowed desktop program.",
    ),
    ConnectorToolDef(
        "computer",
        "computer_press_key",
        "Press desktop key",
        "write",
        "Press a key in an allowed desktop program.",
    ),
    ConnectorToolDef(
        "github",
        "github_search",
