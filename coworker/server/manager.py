...
# An error string with per-process noise removed (origin/main), for change detection
# only: hex object addresses and long digit runs (pids, ports, timestamps) vary between
