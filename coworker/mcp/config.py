...
Workspace: <workspace>/.coworker/mcp.json   (adds non-clashing servers only after
           the user trusts that workspace — same gate as repository
           `allowed_commands`; global definitions win name clashes)
