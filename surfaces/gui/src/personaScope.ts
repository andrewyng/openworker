...
// Persona naming: the product is "Gamer Worker"; the personas are a "Coworker" family — Coworker
...
// API + tests keep "Gamer Worker" / "Ops Coworker"); this is purely the display layer.
