...
export type Item =
  ...
  | {
      ...
      readonlyOk?: boolean;
      // Approval-prompt intent analysis (this PR): plain-language bullets explaining
      // what the operation will do, generated by the session's own model right before
      // the card is raised. Absent = feature off / analysis failed / timed out.
      intent?: string;
