          ...
          <div className={CARD}>
            ...
            {downloading && (
              <div className="border-t border-line px-4 py-3">
                ...
                <div className="mt-1.5 text-[11.5px] text-muted flex"><span>{t("{{used}} of {{total}}", { used: formatBytes(progress?.downloaded_bytes || 0), total: formatBytes(progressTotal) })}</span><span className="ml-auto">{progressPercent}%</span></div>
              </div>
            )}
          </div>
    ...
    <section>
      ...
      <div className={CARD + " p-4 mb-4"} data-testid="language-card">
        ...
        <select
          ...
          className="mt-2.5 w-full max-w-xs px-3 py-2 rounded-lg border border-line bg-paper text-[13px] text-ink outline-none focus:border-accent"
        ...
        <div className={FIELD_HELP}>{t("Changes take effect immediately and are saved on this device.")}</div>
      </div>
