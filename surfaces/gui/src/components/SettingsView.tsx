...
function AppearanceSection() {
  ...
  return (
    <section>
      ...
      <div className={CARD + " p-4 mb-4"} data-testid="interface-language-card">
        <div className={FIELD_LABEL}>{t("Interface language")}</div>
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-[11.5px] text-muted mt-0.5">
                  {workspace.requested_commands.length
                    ? t(workspace.requested_commands.length === 1 ? "{{count}} project command allowance" : "{{count}} project command allowances", { count: workspace.requested_commands.length })
