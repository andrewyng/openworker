        ...
        <div className="space-y-4">
          ...
          <div className={CARD}>
            <div className="p-4 flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-[13.5px] font-medium">{t("settings.voice_device_title")}</div>
          ...
          <div className={CARD}>
            <div className="p-4 flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-[13.5px] font-medium">{t("settings.voice_whisper_title")}</div>
            ...
            {downloading && (
              <div className="border-t border-line px-4 py-3">
                ...
                <div className="mt-1.5 text-[11.5px] text-muted flex">
                  <span>{t("settings.voice_dl_progress", { done: formatBytes(progress?.downloaded_bytes || 0), total: formatBytes(progressTotal) })}</span>
          ...
          <div className={CARD}>
            <div className="p-4 flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-[13.5px] font-medium">{t("settings.voice_mic_test_title")}</div>
                <div className="text-[12px] text-muted mt-0.5">
                  {ready ? t("settings.voice_mic_test_ready") : t("settings.voice_mic_test_pending")}
                </div>
              </div>
              {ready && <span className="text-[11.5px] px-2 py-1 rounded-full bg-green-50 text-green-700">● {t("settings.voice_ready_badge")}</span>}
    ...
    <section>
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          <span className="block text-[13.5px] font-medium">{t("settings.gallery_title")}</span>
