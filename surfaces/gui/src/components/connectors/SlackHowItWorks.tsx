    ...
    <>
            ...
            <Msg
              ...
              extra={
                <span className="hiw-replybar hiw-k" style={d("4.6s")}>
                  <span className="hiw-sav2">OW</span> {t("1 reply")}
      ...
      <OwWin>
        ...
        <div className="hiw-owmain">
          ...
          <div className="hiw-owcomposer">{t("Message OpenWorker…")}</div>
        </div>
      </OwWin>
    </>
  );
            ...
            <Msg
              ...
              extra={
                <span className="hiw-replybar">
                  <span className="hiw-sav2">OW</span> {t("2 replies")}
  ...
  return (
    <>
      ...
      <OwWin>
        ...
        <div className="hiw-owmain">
          <div className="hiw-owtitle">{t("Slack — {{name}}", { name: WS_NAME })}</div>
          <div className="hiw-waitrow hiw-k hiw-glow" style={d("2s", { "--g": "2.5s" })}>
            <span className="min-w-0"><b>Priya N</b> {t("is waiting")}</span>
            <span className="hiw-allowbtn ml-auto">{t("Allow & deliver")}</span>
          </div>
          <div className="hiw-waitcap hiw-k" style={d("3.4s")}>
            {t("Each teammate's first mention waits for your OK — then they're on the People list and it flows.")}
          </div>
        </div>
      </OwWin>
    </>
