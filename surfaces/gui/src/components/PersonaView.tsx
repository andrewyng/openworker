        ...
        <div className="max-w-3xl mx-auto px-7 py-6 space-y-6">
          ...
          {detail.recommends.length > 0 && (
            <section>
              ...
              <p className="text-[12.5px] text-muted mb-2.5">
                {t("Declared by the persona — connect {{persona}} to these to unlock its full workflow.", { persona: shortPersonaName(detail.name, personaId) })}
              </p>
          ...
          {detail.default_connections.length > 0 && (
            <section>
              ...
              <p className="text-[12.5px] text-muted mb-2.5">
                {t("When you start a {{persona}} session these are enabled automatically. You can still mute any of them per session.", { persona: shortPersonaName(detail.name, personaId) })}
              </p>
